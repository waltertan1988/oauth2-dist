...
# 该记录用于演示密码模式
insert into `oauth_client_details` (`client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`) values('grantTypePwDemo',NULL,'grantTypePwDemoSecret',NULL,NULL,NULL,NULL,'3600','86400',NULL,'false');
# 该记录用于演示授权模式
